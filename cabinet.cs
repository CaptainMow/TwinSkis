...
public partial class cabinet : Area2D
{
	...
	public override void _Process(double delta)
	{
        ...
        if (distance <= InteractionRange)
        {
            ...
            {
				newspaper newspaperObj = (newspaper)newspaperScene.Instantiate();
				GetParent().AddChild(newspaperObj);
